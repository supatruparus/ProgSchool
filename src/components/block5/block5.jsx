...
function Block5(){
		return (
				<section className={css.wrapper}>
					<Block5_elem   number = "01" title = "Весь материал разбит на небольшие уроки" text = "Теория и практика подаются маленькими порциями. Так вам будет легче усваивать новые знания."/>
					<Block5_elem    number = "02" 
